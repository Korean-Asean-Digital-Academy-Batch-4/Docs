...
| Tanggal | Perubahan |
|---|---|
| 12 Agustus 2026 | **RILIS PERTAMA BERHASIL — B6 selesai, aplikasi hidup di produksi.** Kesepuluh migrasi diterapkan lewat fungsi `migrate`, yang membuktikan **CK-D-08** bekerja: ia menyala sebagai layanan HTTP, menerima invocation, dan melaporkan hasilnya di dalam payload. Tiga rilis sebelumnya gagal dan masing-masing melahirkan perbaikan — izin ECR yang belum ada saat merge, `lambda:GetFunctionConfiguration` yang tidak pernah didaftar §9.4, dan **CK-A-13** verifikasi sertifikat RDS |
