...
| A-06 | §3.1 menyatakan pembatasan masuk **"dihitung per akun dan per alamat IP"**, sementara [ARCHITECTURE.md Pasal 7](ARCHITECTURE.md) menyatakan pembatasan **"disandarkan pada identitas pengguna, bukan alamat IP — satu sekolah kerap berbagi satu alamat IP publik"**. Dibaca harfiah bersama-sama, keduanya menghasilkan penghitung IP berambang sama, yaitu 5 kegagalan per 15 menit per alamat. Pada sekolah di balik satu NAT, lima kesalahan ketik dari lima siswa berbeda mengunci **seluruh sekolah** selama lima belas menit — persis akibat yang diperingatkan ARCHITECTURE. Tahap A4 karenanya menerapkan pembatasan **per akun saja**, dan tidak menebak ambang IP yang tidak tercantum di dokumen mana pun | Putuskan salah satu, lalu tuliskan angkanya. **(a)** Cukup per akun, dan §3.1 dikoreksi mengikuti ARCHITECTURE. **(b)** Tambahkan penghitung IP dengan ambang tersendiri yang jauh lebih longgar — misalnya beberapa ratus kegagalan per jam — sehingga ia menahan penyerang dari satu mesin tanpa mengunci sekolah. **(c)** Kunci gabungan (akun, IP), yang tidak mengunci sekolah tetapi melemahkan batas per akun karena penyerang cukup berpindah alamat. Selama belum diputuskan, pertahanan yang berlaku adalah batas per akun |
...
**A-06 menghalangi penyelesaian pembatas laju, bukan penyelesaian A4.** Jalur masuk sudah terlindungi batas per akun; yang menunggu hanyalah dimensi keduanya.
